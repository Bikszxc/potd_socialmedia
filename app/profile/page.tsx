                            ...
                            <div className="flex-1 mt-16 md:mt-2 space-y-2">
                                ...
                                <div className="flex flex-wrap gap-4 pt-2">
                                    <Badge variant="secondary" className="px-3 py-1 text-sm bg-primary/10 text-primary hover:bg-primary/20 border-primary/20">
                                        ...
                                        {userData.factionJoined?.faction.name || "No Faction"}
                                    </Badge>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4 text-sm">
                                <div className="grid grid-cols-2 gap-2">
                                    ...
                                    <span className="font-mono text-xs bg-muted p-1 rounded text-center truncate" title={userData.discordId || ""}>
                                        {userData.discordId || "Linked"}
                                    </span>
